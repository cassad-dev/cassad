        ...
        <div className="max-w-screen-xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 lg:gap-4">
              ...
              />
              <img
                className="w-full object-cover rounded-sm mt-6 lg:mt-8"
                src="/img/files.jpg"
      ...
      <section className="py-12 lg:py-32" style={{ backgroundColor: '#f8f8f8' }}>
        <div className="max-w-screen-xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-200">
            {cards.map((card) => (
              <div key={card.number} className="bg-white p-6 lg:p-10">
                <p className="text-[11px] font-semibold tracking-[0.2em] uppercase text-cassad-blue mb-4">
                  {card.number}
                </p>
                ...
                <ul className="space-y-2 lg:space-y-3">
                  {card.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      ...
                      <span className="text-xs lg:text-sm text-gray-500 leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6">
          ...
          <div className="divide-y divide-gray-100">
            {benefits.map((benefit, index) => (
              <div key={index} className="py-6 lg:py-10 grid md:grid-cols-[1fr_2fr] gap-4 md:gap-16 items-start">
