      ...
      >
        <div className="px-4 mx-auto max-w-screen-xl text-center flex flex-col items-center justify-center h-full">
          ...
          <p className="text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
            Nos diferenciamos en estrategias y soluciones de diagnóstico inmobiliario para conectar con clientes de una manera personal y sentido de pertenencia.          </p>
      ...
      {/* <section className="bg-white">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="#" className="space-y-8">
            ...
            <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg bg-mainAzul-100 mx-auto hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Enviar</button>
