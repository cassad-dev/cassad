                ...
                <div className="grid grid-cols-2 md:grid-cols-3 md:gap-8 gap-4">
                    ...
                    <div className="flex flex-col flex-shrink-0">
                        ...
                        <div className="flex items-center gap-x-4 mt-12">
                            ...
                            {/* Email */}
                            <a aria-label="email" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center" href="mailto:mmcassad@gmail.com" target="blank">
